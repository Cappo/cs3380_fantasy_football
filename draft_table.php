<?php
	...
	while($row = pg_fetch_array($result)){
		...
		echo "<td><form method='POST' action='".$_SERVER['PHP_SELF']."' ><input type='hidden' name='id' value='".$row['id']."'><input type='submit' name='submit' class='btn btn-success' value='Draft' /></form></td>";
		echo "</tr>";
	}
	echo "</tbody>";
	echo "</table>";
